...
**singlem** create \[-h\] --input-graftm-package PATH --input-taxonomy PATH --output-singlem-package PATH --hmm-position INTEGER \[--window-size INTEGER\] --target-domains TARGET_DOMAINS \[TARGET_DOMAINS ...\] --gene-description STRING \[--force\] \[--debug\] \[--version\] \[--quiet\] \[--full-help\] \[--full-help-roff\]
