...
**singlem** query \[-h\] --db DB \[--query-otu-table file \[file ...\]\] \[--query-otu-tables-list QUERY_OTU_TABLES_LIST\] \[--query-archive-otu-tables QUERY_ARCHIVE_OTU_TABLES \[QUERY_ARCHIVE_OTU_TABLES ...\]\] \[--query-archive-otu-table-list QUERY_ARCHIVE_OTU_TABLE_LIST\] \[--query-gzip-archive-otu-table-list QUERY_GZIP_ARCHIVE_OTU_TABLE_LIST\] \[--max-nearest-neighbours MAX_NEAREST_NEIGHBOURS\] \[--max-divergence INT\] \[--search-method {smafa-naive}\] \[--sequence-type {nucleotide,protein}\] \[--max-search-nearest-neighbours MAX_SEARCH_NEAREST_NEIGHBOURS\] \[--threads THREADS\] \[--limit-per-sequence LIMIT_PER_SEQUENCE\] \[--preload-db\] \[--sample-names name \[name ...\]\] \[--sample-list path\] \[--taxonomy name\] \[--dump\] \[--continue-on-missing-genes\] \[--debug\] \[--version\] \[--quiet\] \[--full-help\] \[--full-help-roff\]
...
How many nearest neighbours to search before limiting results with --max-nearest-neighbours. \[default: 100\]
