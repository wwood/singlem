...
class Prodigal(object):
    ...
    def _producer(self, genome_file):
        ...
        # Modified paths to cause less confusion for me.
        aa_gene_file = os.path.join(self.output_dir, genome_id + '.faa')
        nt_gene_file = os.path.join(self.output_dir, genome_id + '.fna')
